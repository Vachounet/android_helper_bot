...
class BootlegController extends TelegramBaseController {
    ...
    searchBuild($) {
        ...
        var command = $.message.text.replace("/bootleg", "").trim().split(" ");
        ...
        (async() => {
            ...
            let feed = await parser.parseURL('https://sourceforge.net/projects/bootleggersrom/rss?path=/builds/' + keywords);

            var msg = "*Bootleggers build for " + keywords + "*";
