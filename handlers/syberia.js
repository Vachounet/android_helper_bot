...
class SyberiaController extends TelegramBaseController {
    ...
    searchBuild($) {
        ...
        var command = $.message.text.replace("/syberia", "").trim().split(" ");
        ...
        (async() => {
            ...
            let feed = await parser.parseURL('https://sourceforge.net/projects/syberiaos/rss?path=/' + keywords);

            var msg = "*SyberiaOS build for " + keywords + "*";
